...
private:
	...
	CSceneObject& AddCube(IShader const& shader, double size = 2, CVector3d const& center = CVector3d(), CMatrix4d const& transform = CMatrix4d());
	CSceneObject& AddTetrahedron(
